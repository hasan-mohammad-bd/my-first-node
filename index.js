...
//get this code form express js get started.
...
//middleware
//install cors to allow api to connected with client side.
app.use(cors());
app.use(express.json());

app.get('/', (req, res) => {
    res.send('Hello from my personal Smarty Pant!! with auto restart what the hell is going on')
});
...
//req.params get the qurary as object formate .
